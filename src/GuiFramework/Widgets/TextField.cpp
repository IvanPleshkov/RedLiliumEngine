...
ptr<TextField> TextField::SetFontSize(float size)
{
	m_fontSize = size;
	return this;
}
...
ptr<TextField> TextField::SetTopPadding(float topMargin)
{
	m_topPadding = topMargin;
	return this;
}

ptr<TextField> TextField::SetBottomPadding(float bottomMargin)
{
	m_bottomPadding = bottomMargin;
	return this;
}

ptr<TextField> TextField::SetLeftPadding(float leftMargin)
{
	m_leftPadding = leftMargin;
	return this;
}

ptr<TextField> TextField::SetRightPadding(float rightMargin)
{
...
void TextField::SetTextNvgParameters()
{
